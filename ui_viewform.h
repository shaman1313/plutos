...
public:
    ...
    QCheckBox *checkBox_viewForm_nullNumber;
    ...
    void setupUi(QWidget *viewForm)
    {
        ...
        checkBox_viewForm_nullNumber = new QCheckBox(viewForm);
        checkBox_viewForm_nullNumber->setObjectName(QStringLiteral("checkBox_viewForm_nullNumber"));
        checkBox_viewForm_nullNumber->setChecked(true);

        horizontalLayout->addWidget(checkBox_viewForm_nullNumber);
        ...
        QIcon icon1;
        icon1.addFile(QStringLiteral(":/new/prefix1/ico/exel_256x256.png"), QSize(), QIcon::Normal, QIcon::Off);
        pushButton_viewForm_exel->setIcon(icon1);
    ...
    void retranslateUi(QWidget *viewForm)
    {
        ...
        checkBox_viewForm_nullNumber->setText(QApplication::translate("viewForm", "\320\233\320\270\321\210\320\265 \320\275\320\260\321\217\320\262\320\275\321\226", nullptr));
